...
Working category: Commercial Potential. Working track: Startup.

## Source and deadline

The user supplied the event FAQ. AWS Builder Center search results also corroborated the public AWS app, coding-agent connection evidence, original application, project write-up, category, and track requirements on September 19, 2026. The event-specific rules and connection article could not be opened by the browsing tool; exact rules remain to be checked.
...
- [ ] Confirm country eligibility against official rules.
- [ ] Confirm age, employment/household eligibility, and one-entry requirement.
...
- [ ] Create Builder Center project describing the problem, implementation, process, and agent contribution.
- [ ] Select Commercial Potential and Startup.
